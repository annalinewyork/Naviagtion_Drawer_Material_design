...
public class BaseActivity extends ActionBarActivity {
    ...
    //listView for navi drawer list items.
    protected ListView mDrawerList;
    //List Item array.
    protected String[] titles = {"Profile", "Your Place", "Settings", "Log Out"};
    //selected item position on.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerList.setAdapter(new ArrayAdapter<String>(this, R.layout.custom_row, titles));
        ...
        actionBarDrawerToggle = new ActionBarDrawerToggle(
                ...
                //R.drawable.ic_keyboard_backspace_black_48dp,     /* nav drawer image to replace 'Up' caret */
